...
$USER_NAME ALL=(root) NOPASSWD: $DEST parked
$USER_NAME ALL=(root) NOPASSWD: $DEST cruise
$USER_NAME ALL=(root) NOPASSWD: $DEST busy-demo
EOF
...
echo "  sudo bbb-bench-sim parked"
echo "  sudo bbb-bench-sim cruise"
echo "  sudo bbb-bench-sim busy-demo"
