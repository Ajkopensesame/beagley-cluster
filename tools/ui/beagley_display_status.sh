...
echo "[process-env]"
printf '%s\n' "$env_dump" \
  | grep -E '^(BEAGLEY_UI_VARIANT|BEAGLEY_RENDER_PROFILE|BEAGLEY_EFFECT_LEVEL|BEAGLEY_GAUGE_DETAIL|BEAGLEY_GAUGE_DEMO|BEAGLEY_MAP_RENDERER|BEAGLEY_MAPLIBRE_NATIVE_STYLE_URL|BEAGLEY_MAPLIBRE_NATIVE_FULL_UNDERLAY|BEAGLEY_QML_DEV_ROOT|BEAGLEY_QML_DEV_FILE|BEAGLEY_STRESS_SCENE|QSG_RENDER_LOOP|VEHICLE_HUB_WS_URL)=' \
  | sort || true
