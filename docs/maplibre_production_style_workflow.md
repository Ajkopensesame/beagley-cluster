...
The BeagleY cluster keeps `native-online` as the safe production default until a
MapLibre Native style is proven on the real display. A style is not trusted just
because it downloads on a laptop. It must pass these checks:
